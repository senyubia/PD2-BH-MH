...
## Limitations
- to reveal maps on Hell, zone into one and press reveal, this takes longer than act reveal as maps are more complex (maps however are static so one may wonder why you would want to do it, nevertheless the option is there)
